...
% final - enable microtype; use "draft" to disable tracking=true, kerning=true,
...
% stretchability/shrinkability (default is 20/20)
...
\nomenclature[B00]{$E$}{Young's modulus of elasticity
    \hspace{\fill}\si{\giga\pascal}}
\nomenclature[B01]{$S$}{Far-field stress
    \hspace{\fill}\si{\mega\pascal}}
